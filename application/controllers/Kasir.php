...
class Kasir extends CI_Controller {
	...
	function __construct() {
		...
		check_not_login();
		$this->load->model(['penjualan_m','produk_m', 'supplier_m', 'stock_m', 'kasir_model']);
		}
	...
	public function input_biaya() {
		...
		$this->load->view('template', 'kasir/mesin_kasir',  $data);
	...
	public function retur() {
		$this->load->view('template', 'kasir/mesin_kasir');
	...
	public function go_to_bayar() {
		...
		template("Location: " . $uri, TRUE, $http_response_code);
	}
