...
<section class="content">
	...
	<div class="card shadow ">
		<div class="card-header ">
			<h6 class="m-0 font-weight-bold text-gray"> Add Stock In</h6>
		<div class=" text-right">
			<div align="right"><a href="<?=site_url('stock/in')?>" class="btn btn-blue btn-outline-danger btn-sm">
				...
				<div class="col-md-4 col-md-offset-7">
					<form action="<?=site_url('stock/proses')?>" method="post">
						<div class="form-group">
							...
							<div class="form-group">
							<label>Detail *</label>
									<input type="text" name="detail" class="form-control"  placeholder="Tambahan / Kulakan / etc" required>
							</div>
							<div class="form-group">
							...
							<label>Qty *</label>
								...
								<div align="center">
											<button type="submit" name="in_add" class="btn btn-success btn-flat"> <i class="fa fa-paper-plane"></i> Save</button>
